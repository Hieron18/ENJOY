...
// 		async: false,
// 		type: "POST",
// 		url: "/wp-content/themes/Enjoy/pvp.php",
// 		dataType: "text",
...
let got = document.querySelector(".header__center");
let bodyOpen = document.querySelector(".body");
let language = document.querySelector(".header__language");
menu.addEventListener("click", function() {
   menu.classList.toggle('_open');
   got.classList.toggle('_open');
   language.classList.toggle('_open');
   if(got.classList.contains('_open')){
      bodyOpen.classList.add('_open')
   }else{
      bodyOpen.classList.remove('_open')
   }
});
